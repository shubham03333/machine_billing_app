- [x] Add admin tabs state and filter states in app/page.tsx
- [x] Implement overview tab with updated metrics (revenue, expenses, net profit) and filters for rentals
- [x] Implement expenses tab with table, filters (date range, category, operator), and total calculation
- [x] Add getExpenseCategory function to categorize expenses
- [x] Test the admin dashboard functionality
=======
# TODO: Add edit/update options for rental and expense in admin dashboard
